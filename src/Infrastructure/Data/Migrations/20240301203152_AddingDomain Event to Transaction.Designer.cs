...
namespace Organizer.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240301203152_AddingDomain Event to Transaction")]
    partial class AddingDomainEventtoTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Organizer.Domain.Entities.TodoItem", b =>
                {
                    b.HasOne("Organizer.Domain.Entities.TodoList", "List")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Organizer.Domain.Entities.TodoList", b =>
                {
                    b.OwnsOne("Organizer.Domain.ValueObjects.Colour", "Colour", b1 =>
                        {
            ...
            modelBuilder.Entity("Organizer.Domain.Entities.Feminist", b =>
                {
                    b.Navigation("FeministsCollectives");
                });
